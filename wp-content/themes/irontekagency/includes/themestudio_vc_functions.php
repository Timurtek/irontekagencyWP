   ...
   "params" => array(
		...
		array(
   		...
   		array(
              ...
              "param_name" => "content",
              "value" =>'',
              "description" => __("Add content for list style.<br /> Default:1|Nam aliquet massa id gravida venenatis.|(url).<br /> Style icon:fa-facebook|Nam aliquet massa id gravida venenatis.|(url).<br />Unstyled:Nam aliquet massa id gravida venenatis.|(url).<br />
...
vc_map( array(
    ...
    "params" => array(
      ...
      array(
			...
			"value" => array( 'Layout style 1' => "style1",
	...
	vc_map( array(
	    ...
	    "params" => array(
			...
			array(
			    ...
			    "value" => '',
				"description" => __("Add url for link price list. eg: http://your-domain.com/whmcs-bridge/?ccce=domainchecker",'themestudio')
	     	 ),
			array(
			    "type" => "textfield",
			    "holder" => "div",
			...
			array(
			    ...
			    "value" => '',
				"description" => __("Add url for link price list. eg: http://your-domain.com/whmcs-bridge/?ccce=domainchecker&search=bulk",'themestudio')
	     	 ),
			array(
			    "type" => "textfield",
			    "holder" => "div",
			...
			array(
			    ...
			    "value" => '',
				"description" => __("Add url for link price list. eg: http://your-domain.com/whmcs-bridge/?ccce=domainchecker&search=bulktransfer",'themestudio')
	     	 ),
			array(
			    "type" => "textfield",
			    "holder" => "div",
